...
namespace DuiLib {
    ...
    public:
        ...
        static CMenuWnd* CreateMenu(CMenuElementUI* pOwner, STRINGorID xml, STRINGorID type, POINT point,
    ...
    public:
        ...
        void Init(CMenuElementUI* pOwner, STRINGorID xml, STRINGorID type, POINT point,
            CPaintManagerUI* pMainPaintManager, CStdStringPtrMap* pMenuCheckInfo = NULL,
            DWORD dwAlignment = eMenuAlignment_Left | eMenuAlignment_Top);
